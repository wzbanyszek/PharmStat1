    ...
    **{t["instructions"]["header"]}:**
    ...
    if uploaded_file is not None:
        try:
            ...
            target = st.number_input(t["spec_settings"]["target"], value=0, format="%0.2f")
            LSL = st.number_input(t["spec_settings"]["lsl"], value=0, format="%0.2f")
            USL = st.number_input(t["spec_settings"]["usl"], value=0, format="%0.2f")
